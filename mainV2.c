 ...
 *	"scanf" permet de creer une char définie ici 255.
 */
...
/* On parcours le mot avec strlen 
...
/* On test la lettre 
 * création du tableau on va tester la lettre obtenu dans la fonction caractere()
 * on test la lettre pour chaque lettre du mot secret
...
/* grace a lettreTrouve qui est égal à 0 ou 1
 * si on a trouvé aucune lettre dans le mot secret
 * alors on enléve une vie au joueur et on affiche du text
 */
...
/* on dessine les differentes phases du pendu
 *
 */
/*******************************************************************************/
